    ...
    public class VOSSynchronizationMessages
    {
        ...
        public class EntityInfo
        {
            ...
            public EntityInfo(Guid _id, string _tag, string _type, string _path,
                ...
                Vector3 _scaleSize, bool isSize, Vector2 _positionPercent,
                Vector2 _sizePercent, string _onClick, float _length,
                float _width, float _height, float[,] _heights, string _text,
                int _fontSize)
            {
                id = _id.ToString();
                tag = _tag;
        ...
        public class RequestMessages
        {
            ...
            public class AddCharacterEntityMessage
            {
                ...
                public AddCharacterEntityMessage(Guid _messageID, Guid _clientID,
                    ...
                    string _path, Vector3 _position, Quaternion _rotation,
