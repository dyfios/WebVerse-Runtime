...
namespace FiveSQD.WebVerse.Handlers.VEML
{
    ...
    {
        /// <summary>
        /// Convert the schema instance from version 1.2 to the current schema (version 1.3).
        /// </summary>
        /// <param name="inputVEML">Input VEML instance.</param>
        /// <returns>Current schema version for the input VEML instance.</returns>
        public static Schema.V1_3.veml ConvertFromV1_2(Schema.V1_2.veml inputVEML)
        {
            Schema.V1_3.veml outputVEML = new Schema.V1_3.veml();
            if (inputVEML.metadata != null)
            {
                // Set up metadata.
                outputVEML.metadata = new Schema.V1_3.vemlMetadata();
                ...
                // Assign input events.
                List<Schema.V1_3.inputevent> outputVEMLInputEvents = new List<Schema.V1_3.inputevent>();
                if (inputVEML.metadata.inputevent != null)
                {
                    foreach (Schema.V1_2.inputevent inputEvent in inputVEML.metadata.inputevent)
                    {
                        Schema.V1_3.inputevent outputVEMLInputEvent = new Schema.V1_3.inputevent();
                ...
                List<Schema.V1_3.synchronizationservice> outputVEMLSynchronizationServices
                    = new List<Schema.V1_3.synchronizationservice>();
                if (inputVEML.metadata.synchronizationservice != null)
                {
                    ...
                    {
                        Schema.V1_3.synchronizationservice outputVEMLSynchronizationService
                            = new Schema.V1_3.synchronizationservice();
            ...
            {
                // Set up environment.
                outputVEML.environment = new Schema.V1_3.vemlEnvironment();

                // Assign background.
                if (inputVEML.environment.background != null)
                {
                    outputVEML.environment.background = new Schema.V1_3.background();
                    ...
                    switch (inputVEML.environment.background.ItemElementName)
                    {
                        case Schema.V1_2.ItemChoiceType.panorama:
                            outputVEML.environment.background.ItemElementName = Schema.V1_3.ItemChoiceType.panorama;
                            break;

                        case Schema.V1_2.ItemChoiceType.color:
                        default:
                            outputVEML.environment.background.ItemElementName = Schema.V1_3.ItemChoiceType.color;
                            break;
                    }
                }

                // Set up entities.
                List<Schema.V1_3.entity> outputVEMLEntities = new List<Schema.V1_3.entity>();
                if (inputVEML.environment.entity != null)
                {
                    foreach (Schema.V1_2.entity e in inputVEML.environment.entity)
                    {
                        Queue<KeyValuePair<Schema.V1_2.entity, Schema.V1_3.entity>> entityQueue
                            = new Queue<KeyValuePair<Schema.V1_2.entity, Schema.V1_3.entity>>();
                        entityQueue.Enqueue(new KeyValuePair<Schema.V1_2.entity, Schema.V1_3.entity>(e, null));
                        while (entityQueue.Count > 0)
                        {
                            KeyValuePair<Schema.V1_2.entity, Schema.V1_3.entity> item = entityQueue.Dequeue();

                            Schema.V1_3.entity outputVEMLEntity = ConvertEntityFromV1_2(item.Key);

                            if (item.Key.entity1 != null)
                            {
                                foreach (Schema.V1_2.entity child in item.Key.entity1)
                                {
                                    entityQueue.Enqueue(new KeyValuePair<Schema.V1_2.entity, Schema.V1_3.entity>
                            ...
                            if (item.Value != null)
                            {
                                item.Value.entity1 = AddToV1_3EntityArray(item.Value.entity1, outputVEMLEntity);
                            }
        ...
        /// <summary>
        /// Convert the schema instance from version 1.1 to the current schema (version 1.3).
        /// </summary>
        /// <param name="inputVEML">Input VEML instance.</param>
        /// <returns>Current schema version for the input VEML instance.</returns>
        public static Schema.V1_3.veml ConvertFromV1_1(Schema.V1_1.veml inputVEML)
        {
            Schema.V1_3.veml outputVEML = new Schema.V1_3.veml();
            if (inputVEML.metadata != null)
            {
            ...
            if (inputVEML.environment != null)
            {
                ...
                if (inputVEML.environment.entity != null)
                {
                    ...
                    {
                        Queue<KeyValuePair<Schema.V1_1.entity, Schema.V1_3.entity>> entityQueue
                            = new Queue<KeyValuePair<Schema.V1_1.entity, Schema.V1_3.entity>>();
                        entityQueue.Enqueue(new KeyValuePair<Schema.V1_1.entity, Schema.V1_3.entity>(e, null));
                        while (entityQueue.Count > 0)
                        {
                            KeyValuePair<Schema.V1_1.entity, Schema.V1_3.entity> item = entityQueue.Dequeue();

                            Schema.V1_3.entity outputVEMLEntity = ConvertEntityFromV1_1(item.Key);

                            if (item.Key.entity1 != null)
                            {
                                foreach (Schema.V1_1.entity child in item.Key.entity1)
                                {
                                    entityQueue.Enqueue(new KeyValuePair<Schema.V1_1.entity, Schema.V1_3.entity>
                                        (child, outputVEMLEntity));
                                }
                            }
        ...
        /// <summary>
        /// Convert the schema instance from version 1.0 to the current schema (version 1.3).
        /// </summary>
        /// <param name="inputVEML">Input VEML instance.</param>
        /// <returns>Current schema version for the input VEML instance.</returns>
        public static Schema.V1_3.veml ConvertFromV1_0(Schema.V1_0.veml inputVEML)
        {
            Schema.V1_3.veml outputVEML = new Schema.V1_3.veml();
            if (inputVEML.metadata != null)
            {
            ...
            if (inputVEML.environment != null)
            {
                ...
                if (inputVEML.environment.entity != null)
                {
                    ...
                    {
                        Queue<KeyValuePair<Schema.V1_0.entity, Schema.V1_3.entity>> entityQueue
                            = new Queue<KeyValuePair<Schema.V1_0.entity, Schema.V1_3.entity>>();
                        entityQueue.Enqueue(new KeyValuePair<Schema.V1_0.entity, Schema.V1_3.entity>(e, null));
                        while (entityQueue.Count > 0)
                        {
                            KeyValuePair<Schema.V1_0.entity, Schema.V1_3.entity> item = entityQueue.Dequeue();

                            Schema.V1_3.entity outputVEMLEntity = ConvertEntityFromV1_0(item.Key);

                            if (item.Key.entity1 != null)
                            {
                                foreach (Schema.V1_0.entity child in item.Key.entity1)
                                {
                                    entityQueue.Enqueue(new KeyValuePair<Schema.V1_0.entity, Schema.V1_3.entity>
                                        (child, outputVEMLEntity));
                                }
                            }
        ...
        /// <summary>
        /// Convert an entity from version 1.2 to the current schema (version 1.3).
        /// </summary>
        /// <param name="entity">Input entity instance.</param>
        /// <returns>Current schema version for the input entity instance.</returns>
        private static Schema.V1_3.entity ConvertEntityFromV1_2(Schema.V1_2.entity entity)
        {
            // Assign entity.
            Schema.V1_3.entity outputEntity;

            // Button Entity.
            if (entity is Schema.V1_2.buttonentity)
            {
                outputEntity = new Schema.V1_3.buttonentity();
                ((Schema.V1_3.buttonentity) outputEntity).onclickevent
            ...
            {
                outputEntity = new Schema.V1_3.canvasentity();
            }

            // Character Entity.
            else if (entity is Schema.V1_2.characterentity)
            {
                outputEntity = new Schema.V1_3.characterentity();
            }

            // Container Entity.
            else if (entity is Schema.V1_2.containerentity)
            {
                outputEntity = new Schema.V1_3.containerentity();
            }

            // HTML Entity.
            else if (entity is Schema.V1_2.htmlentity)
            {
                outputEntity = new Schema.V1_3.htmlentity();
                ((Schema.V1_3.htmlentity) outputEntity).onmessage
                    = ((Schema.V1_2.htmlentity) entity).onmessage;
                ((Schema.V1_3.htmlentity) outputEntity).url
            ...
            {
                outputEntity = new Schema.V1_3.inputentity();
            }

            // LightEntity.
            else if (entity is Schema.V1_2.lightentity)
            {
                outputEntity = new Schema.V1_3.lightentity();
            }

            // Mesh Entity.
            else if (entity is Schema.V1_2.meshentity)
            {
                outputEntity = new Schema.V1_3.meshentity();
                ((Schema.V1_3.meshentity) outputEntity).meshresource
                    = ((Schema.V1_2.meshentity) entity).meshresource;
                ((Schema.V1_3.meshentity) outputEntity).meshname
            ...
            {
                outputEntity = new Schema.V1_3.terrainentity();
                ((Schema.V1_3.terrainentity) outputEntity).height
                    = ((Schema.V1_2.terrainentity) entity).height;
                ((Schema.V1_3.terrainentity) outputEntity).heights
                    = ((Schema.V1_2.terrainentity) entity).heights;
                List<Schema.V1_3.terrainentitylayer> outputLayers
                    = new List<Schema.V1_3.terrainentitylayer>();
                if (((Schema.V1_2.terrainentity) entity).layer != null)
                {
                    ...
                    {
                        Schema.V1_3.terrainentitylayer outputLayer
                            = new Schema.V1_3.terrainentitylayer();
                ...
                ((Schema.V1_3.terrainentity) outputEntity).layer
                    = outputLayers.ToArray();
                ((Schema.V1_3.terrainentity) outputEntity).layermasks
                    = ((Schema.V1_2.terrainentity) entity).layermasks;
                ((Schema.V1_3.terrainentity) outputEntity).length
                    = ((Schema.V1_2.terrainentity) entity).length;
                ((Schema.V1_3.terrainentity) outputEntity).width
                    = ((Schema.V1_2.terrainentity) entity).width;
                ((Schema.V1_3.terrainentity) outputEntity).type
            ...
            {
                outputEntity = new Schema.V1_3.textentity();
                ((Schema.V1_3.textentity) outputEntity).text
                    = ((Schema.V1_2.textentity) entity).text;
                ((Schema.V1_3.textentity) outputEntity).fontsize
            ...
            {
                outputEntity = new Schema.V1_3.voxelentity();
            }

            // Default to Base Entity.
            else
            {
                outputEntity = new Schema.V1_3.entity();
            }
            ...
            if (entity.transform != null)
            {
                ...
                if (entity.transform is Schema.V1_2.canvastransform)
                {
                    ...
                    outputEntity.transform = new Schema.V1_3.canvastransform();

                    // Assign Position Percent.
                    if (((Schema.V1_2.canvastransform) entity.transform).positionpercent != null)
                    {
                        ((Schema.V1_3.canvastransform) outputEntity.transform).positionpercent =
                            new Schema.V1_3.positionpercent();
                        ((Schema.V1_3.canvastransform) outputEntity.transform).positionpercent.x =
                            ((Schema.V1_2.canvastransform) entity.transform).positionpercent.x;
                        ((Schema.V1_3.canvastransform) outputEntity.transform).positionpercent.y =
                    ...
                    {
                        ((Schema.V1_3.canvastransform) outputEntity.transform).sizepercent =
                            new Schema.V1_3.sizepercent();
                        ((Schema.V1_3.canvastransform) outputEntity.transform).sizepercent.x =
                            ((Schema.V1_2.canvastransform) entity.transform).sizepercent.x;
                        ((Schema.V1_3.canvastransform) outputEntity.transform).sizepercent.y =
                ...
                else if (entity.transform is Schema.V1_2.scaletransform)
                {
                    ...
                    outputEntity.transform = new Schema.V1_3.scaletransform();

                    // Assign Position.
                    if (((Schema.V1_2.scaletransform) entity.transform).position != null)
                    {
                        ((Schema.V1_3.scaletransform) outputEntity.transform).position =
                            new Schema.V1_3.position();
                        ((Schema.V1_3.scaletransform) outputEntity.transform).position.x =
                            ((Schema.V1_2.scaletransform) entity.transform).position.x;
                        ((Schema.V1_3.scaletransform) outputEntity.transform).position.y =
                            ((Schema.V1_2.scaletransform) entity.transform).position.y;
                        ((Schema.V1_3.scaletransform) outputEntity.transform).position.z =
                    ...
                    {
                        ((Schema.V1_3.scaletransform) outputEntity.transform).rotation =
                            new Schema.V1_3.rotation();
                        ((Schema.V1_3.scaletransform) outputEntity.transform).rotation.x =
                            ((Schema.V1_2.scaletransform) entity.transform).rotation.x;
                        ((Schema.V1_3.scaletransform) outputEntity.transform).rotation.y =
                            ((Schema.V1_2.scaletransform) entity.transform).rotation.y;
                        ((Schema.V1_3.scaletransform) outputEntity.transform).rotation.z =
                            ((Schema.V1_2.scaletransform) entity.transform).rotation.z;
                        ((Schema.V1_3.scaletransform) outputEntity.transform).rotation.w =
                    ...
                    {
                        ((Schema.V1_3.scaletransform) outputEntity.transform).scale =
                            new Schema.V1_3.scale();
                        ((Schema.V1_3.scaletransform) outputEntity.transform).scale.x =
                            ((Schema.V1_2.scaletransform) entity.transform).scale.x;
                        ((Schema.V1_3.scaletransform) outputEntity.transform).scale.y =
                            ((Schema.V1_2.scaletransform) entity.transform).scale.y;
                        ((Schema.V1_3.scaletransform) outputEntity.transform).scale.z =
                ...
                else if (entity.transform is Schema.V1_2.sizetransform)
                {
                    ...
                    outputEntity.transform = new Schema.V1_3.sizetransform();

                    // Assign Position.
                    if (((Schema.V1_2.sizetransform) entity.transform).position != null)
                    {
                        ((Schema.V1_3.sizetransform) outputEntity.transform).position =
                            new Schema.V1_3.position();
                        ((Schema.V1_3.sizetransform) outputEntity.transform).position.x =
                            ((Schema.V1_2.sizetransform) entity.transform).position.x;
                        ((Schema.V1_3.sizetransform) outputEntity.transform).position.y =
                            ((Schema.V1_2.sizetransform) entity.transform).position.y;
                        ((Schema.V1_3.sizetransform) outputEntity.transform).position.z =
                    ...
                    {
                        ((Schema.V1_3.sizetransform) outputEntity.transform).rotation =
                            new Schema.V1_3.rotation();
                        ((Schema.V1_3.sizetransform) outputEntity.transform).rotation.x =
                            ((Schema.V1_2.sizetransform) entity.transform).rotation.x;
                        ((Schema.V1_3.sizetransform) outputEntity.transform).rotation.y =
                            ((Schema.V1_2.sizetransform) entity.transform).rotation.y;
                        ((Schema.V1_3.sizetransform) outputEntity.transform).rotation.z =
                            ((Schema.V1_2.sizetransform) entity.transform).rotation.z;
                        ((Schema.V1_3.sizetransform) outputEntity.transform).rotation.w =
                    ...
                    {
                        ((Schema.V1_3.sizetransform) outputEntity.transform).size =
                            new Schema.V1_3.size();
                        ((Schema.V1_3.sizetransform) outputEntity.transform).size.x =
                            ((Schema.V1_2.sizetransform) entity.transform).size.x;
                        ((Schema.V1_3.sizetransform) outputEntity.transform).size.y =
                            ((Schema.V1_2.sizetransform) entity.transform).size.y;
                        ((Schema.V1_3.sizetransform) outputEntity.transform).size.z =
                ...
                {
                    outputEntity.transform = new Schema.V1_3.basetransform();
                }
            }
            ...
            List<Schema.V1_3.placementsocket> outputPlacementSockets = new List<Schema.V1_3.placementsocket>();
            if (entity.placementsocket != null)
            {
                foreach (Schema.V1_2.placementsocket placementSocket in entity.placementsocket)
                {
                    Schema.V1_3.placementsocket outputPlacementSocket = new Schema.V1_3.placementsocket();
                    outputPlacementSocket.position = new Schema.V1_3.position();
                    ...
                    outputPlacementSocket.rotation = new Schema.V1_3.rotation();
                    ...
                    outputPlacementSocket.connectingoffset = new Schema.V1_3.position();
        ...
        /// <summary>
        /// Convert an entity from version 1.1 to the current schema (version 1.3).
        /// </summary>
        /// <param name="entity">Input entity instance.</param>
        /// <returns>Current schema version for the input entity instance.</returns>
        private static Schema.V1_3.entity ConvertEntityFromV1_1(Schema.V1_1.entity entity)
        {
            // Assign entity.
            Schema.V1_3.entity outputEntity;
            ...
            else if (entity is Schema.V1_1.terrainentity)
            {
                ...
                ((Schema.V1_3.terrainentity) outputEntity).layer = null;
                ((Schema.V1_3.terrainentity) outputEntity).layermasks = null;
                ((Schema.V1_3.terrainentity) outputEntity).length
        ...
        /// <param name="entity">Input entity instance.</param>
        /// <returns>Current schema version for the input entity instance.</returns>
        private static Schema.V1_3.entity ConvertEntityFromV1_0(Schema.V1_0.entity entity)
        {
            // Assign entity.
            Schema.V1_3.entity outputEntity;
        ...
        /// <summary>
        /// Add an entity to a Version 1.3 entity array.
        /// </summary>
        ...
        private static Schema.V1_3.entity[] AddToV1_3EntityArray(Schema.V1_3.entity[] baseArray,
            Schema.V1_3.entity entityToAdd)
        {
            List<Schema.V1_3.entity> entityList;
            if (baseArray == null)
            {
                entityList = new List<Schema.V1_3.entity>();
            }
            else
            {
                entityList = new List<Schema.V1_3.entity>(baseArray);
            }
